...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.getOption = function(req, dotPathOrArray, def) {
      ...
      if (editable) {
        var value = overrideOptions.getNewOptionValue(req, req.aposOptions[self.__meta.name], path, overrideOptions.getEditableFieldValue(req.aposRenderingWidget, dotPathOrArray));
        if (value || (value === 0)) {
          return value;
        }
      }
